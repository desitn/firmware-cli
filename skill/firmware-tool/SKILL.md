...
# 保存日志
firmware-cli.exe monitor -p COM3 --timeout 60000 -o output.log

# JSON 输出
firmware-cli.exe monitor -p COM3 --json --timeout 5000
...
# 查询厂商
firmware-cli.exe at -c "AT+CGMI"

# 查询型号
firmware-cli.exe at -c "AT+CGMM"
